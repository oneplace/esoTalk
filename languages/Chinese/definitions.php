...
ET::$languageInfo["Chinese"] = array(
	"locale" => "zh-CN",
	"name" => "Chinese",
	"description" => "A simple Chinese language pack.",
	"version" => ESOTALK_VERSION,
	"author" => "chuck911",
	"authorEmail" => "contact@with.cat",
	"authorURL" => "http://log.with.cat",
	"license" => "GPLv2"
);
...
$definitions["Filter conversations..."] = "过滤...";
...
//plus
$definitions["Username or Email"] = "用户名或密码";
$definitions["Keep me logged in"] = "下次自动登录";
$definitions["Don't have an account? <a href='%s' class='link-join'>Sign up!</a>"] = "还没有帐号? <a href='%s' class='link-join'>注册!</a>";